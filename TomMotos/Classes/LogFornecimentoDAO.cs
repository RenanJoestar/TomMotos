...
namespace TomMotos.Classes
{
    class LogFornecimentoDAO
    {
        ...
        public DataTable ListarTodosFornecimentoS()
        {
            string sql = @"select tb_log_fornecimento.id_log_fornecimento AS 'ID DO FORNECIMENTO', tb_produto.descricao_produto AS 'NOME DO PRODUTO', tb_produto.quantidade_produto AS 'QUANTIDADE DO PRODUTO',
                ...
                order by tb_log_fornecimento.data_log_fornecimento desc;";
        ...
        #region LISTAR LOG FORNECIMENTO POR FILTRO
        public DataTable listarLogFornecimentoPor(string finalSQL)
        {
            ...
            string select = @"select tb_log_fornecimento.id_log_fornecimento AS 'ID DO FORNECIMENTO', tb_produto.descricao_produto AS 'NOME DO PRODUTO', tb_produto.quantidade_produto AS 'QUANTIDADE DO PRODUTO',
		        ...
		        on tb_log_fornecimento.fk_produto_id = tb_produto.id_produto
		        inner join tb_fornecedor
		        on tb_log_fornecimento.fk_fornecedor_id = tb_fornecedor.id_fornecedor where " + finalSQL + " order by tb_log_fornecimento.data_log_fornecimento desc";
