...
namespace TomMotos.Classes
{
    class EnderecoDAO
    {
        ...
        {
            string sql = @"select id_endereco AS 'ID', rua_endereco AS 'RUA', numero_endereco AS 'NÚMERO',  bairro_endereco AS 'BAIRRO', cidade_endereco AS 'CIDADE', cep_endereco AS 'CEP'  from tb_endereco where fk_usuario_id = @id";
